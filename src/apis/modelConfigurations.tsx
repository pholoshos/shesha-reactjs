...
export type ModelConfigurationsUpdateProps = Omit<
  MutateProps<
    ModelConfigurationDtoAjaxResponse,
    AjaxResponseBase,
    ModelConfigurationsUpdateQueryParams,
...
export const useModelConfigurationsUpdate = (props: UseModelConfigurationsUpdateProps) =>
  useMutate<
    ...
    ModelConfigurationDto,
    void
  >('PUT', `/api/ModelConfigurations`, props);
...
export type ModelConfigurationsCreateProps = Omit<
  MutateProps<
    ModelConfigurationDtoAjaxResponse,
    AjaxResponseBase,
    ModelConfigurationsCreateQueryParams,
    ModelConfigurationDto,
    void
  >,
  'path' | 'verb'
...
export const useModelConfigurationsCreate = (props: UseModelConfigurationsCreateProps) =>
  useMutate<
    ...
    ModelConfigurationDto,
    void
  >('POST', `/api/ModelConfigurations`, props);
...
export type ModelConfigurationsGetByIdProps = Omit<
  GetProps<
    ModelConfigurationDtoAjaxResponse,
    AjaxResponseBase,
    ModelConfigurationsGetByIdQueryParams,
...
export const modelConfigurationsGetById = (
  queryParams: ModelConfigurationsGetByIdQueryParams,
...
export const useModelConfigurationsMerge = (props: UseModelConfigurationsMergeProps) =>
  useMutate<
    ModelConfigurationDtoAjaxResponse,
    AjaxResponseBase,
    ModelConfigurationsMergeQueryParams,
    MergeConfigurationDto,
    void
  >('POST', `/api/ModelConfigurations/merge`, props);
